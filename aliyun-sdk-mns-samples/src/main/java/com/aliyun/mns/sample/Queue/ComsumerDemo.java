...
public class ComsumerDemo {
	...
	String comsumercontent="";
	String[] comsumercontents;
	
	 public String get(String message) {
	    	message=comsumercontent;
	    	return message;
	    }
	 public String[] getsome(String[] message) {
		 message=comsumercontents;
	     return message;
	    }
        ...
        try{
          ...
          // while(true) {
           ...
           if (popMsg != null){
                System.out.println("message handle: " + popMsg.getReceiptHandle());
                System.out.println("message body: " + popMsg.getMessageBodyAsString());
               // if(popMsg.getMessageBodyAsString()!=null) {
                comsumercontent+=popMsg.getMessageBodyAsString()+"\n";
